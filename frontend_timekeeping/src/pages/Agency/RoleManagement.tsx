...
const RoleManagement: React.FC = () => {
    ...
    const fetchRoles = async (search?: string, page = 1, pageSize = 10) => {
        try {
            ...
            notificationApi.error({
                ...
                description: error.response?.data?.error || "Không thể tải danh sách quyền.",
                placement: "topRight",
            });
        }
    };
        ...
        try {
            ...
            if (editingRole) {
                ...
                notificationApi.success({
                    ...
                    description: `quyền "${payload.Name}" đã được cập nhật thành công.`,
                    placement: "topRight",
                });
            } else {
                ...
                notificationApi.success({
                    message: "Thêm quyền",
                    description: `quyền "${payload.Name}" đã được thêm thành công.`,
                    placement: "topRight",
                });
            }
            ...
            notificationApi.error({
                ...
                description: error.response?.data?.error || "Không thể lưu quyền.",
                placement: "topRight",
            });
        }
    };
    ...
    const handleDelete = async (id: number) => {
        try {
            ...
            notificationApi.success({
                message: "Xóa quyền",
                description: `quyền "${deletedRole?.Name}" đã được xóa thành công.`,
                placement: "topRight",
            });
            fetchRoles(searchValue, pagination.current, pagination.pageSize);
        } catch (error: any) {
            ...
            notificationApi.error({
                ...
                description: error.response?.data?.error || "Không thể xóa quyền.",
                placement: "topRight",
            });
        }
    };
    ...
    return (
        <MainLayout title="Quản lý quyền">
            ...
            <Modal
                title={editingRole ? "Sửa quyền" : "Tạo mới quyền"}
